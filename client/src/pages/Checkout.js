...
const Authcheckorder = () => {
    if (checkAuth) {
            <Container>
            <h2>Авторизуйтесь чтобы заказ сохранился в вашей истории</h2>
            <NavLink to="/login" className="nav-link"><Button>Войти</Button></NavLink>
            <h2> Или </h2>
            <NavLink to="/signup" className="nav-link"><Button>Зарегестрироваться</Button></NavLink>
            </Container>
    }
}
const Checkout = () => {
    ...
    return (
        <Container>
            ...
            <div>Если пользователь не авторизован, то заказ не сохранится в вашем личном кабинете</div>
